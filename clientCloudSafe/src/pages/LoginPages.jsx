                ...
                <div className="sm:w-1/2 px-16">
                    ...
                    <form className="flex flex-col gap-4" action="">
                        <div className="relative">
                            <input className="p-2 mt-2 rounded-xl border w-full" type="email" {...login("email", {required:true})} placeholder="Email"/>
                            <input className="p-2 mt-2 rounded-xl border w-full" type="password" {...login("password", {required:true})} placeholder="Password"/>
                    ...
                    <div className="mt-3 text-xs flex justify-between items-center">
                        <p className="mt-1 text-xs border-gray-400 py-4">Don't have an account yet?</p>
