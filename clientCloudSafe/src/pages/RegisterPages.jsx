                ...
                <div className="sm:w-1/2 px-16">
                    ...
                    <form className="flex flex-col gap-4" onSubmit={onSubmit}>
                        <div className="relative">
                            ...
                            <input className="p-2 mt-2 rounded-xl border w-full" type="password" placeholder="Password" {...register("password", {required:true})}/>
                            ...
                            <input className="p-2 mt-2 rounded-xl border w-full" type="password" placeholder="Confirm password" {...register("confirmPassword", {required:true})}/>
